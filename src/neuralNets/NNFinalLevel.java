...
public class NNFinalLevel extends NNBase {
	final static int NUM_HIDDEN_NODES = 20;

	public NNFinalLevel(double[][] trainIn, double[][] trainOut, int iterations) throws Exception {
